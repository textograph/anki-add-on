! function(t, e) { if ("function" == typeof define && define.amd) define(["d3"], e);
    else if ("object" == typeof module && module.exports) { var n = require("d3");
        module.exports = e(n) } else t.d3.tip = e(t.d3) }(this, function(t) { return function() {
        ...
        function h() { for (var e = E || t.event.target;
                "undefined" == typeof e.getScreenCTM && "undefined" === e.parentNode;) e = e.parentNode; var n = {},
                r = e.getScreenCTM(),
                o = e.getBBox(),
                l = o.width,
                i = o.height,
                f = o.x,
                u = o.y; return C.x = f, C.y = u, n.nw = C.matrixTransform(r), C.x += l, n.ne = C.matrixTransform(r), C.y += i, n.se = C.matrixTransform(r), C.x -= l, n.sw = C.matrixTransform(r), C.y -= i / 2, n.w = C.matrixTransform(r), C.x += l, n.e = C.matrixTransform(r), C.x -= l / 2, C.y -= i / 2, n.n = C.matrixTransform(r), C.y += i, n.s = C.matrixTransform(r), n }

        function x(t) { return "function" == typeof t ? t : function() { return t } } var v = n,
            g = r,
            w = o,
            T = y(),
            b = null,
